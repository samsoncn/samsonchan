...
import { FormButton, FormContent, FormH1, FormEmailInput, FormTextarea, FormLabel, FormWrap, Text, Icon, Form, Container, Message } from './ContactElements';
...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_39n8aka', 'template_jy6lzqn', e.target, 'user_jux9Xh96WoNyiIsBcpe9D')
          .then((result) => {
